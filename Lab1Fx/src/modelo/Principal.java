...
public class Principal {
	...
	/**
	 * False: Integer true:Double
	 */
	public boolean verificateIntegerDouble(String cadena) {
		boolean verificate = false;

		String[] ver = cadena.split(",");
		double first = (double) Double.parseDouble(ver[0]);

		if (first % 1 == 0) {
			verificate = false;
//			ArrayList<Integer> number= new ArrayList<Integer>();
//			setNumbersInteger(cadena, number);

		} else {
			verificate = true;
//			ArrayList<Double> number= new ArrayList<Double>();
//					setNumbers(cadena, number);
	...
	public ArrayList<Double> setNumbers(String cadena, ArrayList<Double> numbers) {
